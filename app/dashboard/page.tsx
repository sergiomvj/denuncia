      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          {userIsAdmin && (
            ...
            >
              <div className="text-4xl mb-3">🎬</div>
              <h3 className="font-semibold text-gray-900 group-hover:text-[#F97316]">Videos</h3>
              <p className="text-sm text-gray-600">Admin: CRUD de videos e destaque do hero da home</p>
            </Link>
          )}
          {userIsAdmin && (
            <Link
